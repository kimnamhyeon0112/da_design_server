...
def test_logger():
    ...
    :rtype: bool
    """
    from da_design_server.src import mylogger
    try:
        m = mylogger.get_logger('test', '/home/u1002/da_design_server/log')
        m.debug('hi, debug')
...
def test_config():
    ...
    :rtype: bool
    """
    from da_design_server.src import myconfig
    try:
        m = myconfig.get_config('/home/u1002/da_design_server/share/test.config')
